  ...
  <div class="parking-add">
    <el-form ref="form" :model="form" label-width="120px">
      ...
      <el-form-item label="年检">
        <el-radio-group v-model="form.yearCheck">
      ...
      <el-form-item label="保养日期">
        <el-row :gutter="30">
          <el-col :span="6">
            <el-input v-model="form.maintainDate"></el-input>
          </el-col>
          <el-col :span="6">下次保养日期：2020-12-12</el-col>
        </el-row>
      </el-form-item>
      <el-form-item label="档位">
        <el-radio-group v-model="form.gear">
      ...
      <el-form-item label="能源类型">
        ...
        <div class="progress-bar-wrap" v-if="form.energyType == 3 || form.energyType == 1">
          <span class="label-text">电量：</span>
          <el-row :gutter="20">
            <el-col :span="5">
              <div class="progress-bar">
                <span style="width: 50%;">
                  <label>{{form.electric}}%</label>
                </span>
              </div>
            </el-col>
            <el-col :span="2">
              <el-input size="small" value="100" v-model="form.electric"></el-input>
            </el-col>
          </el-row>
        </div>
        <div class="progress-bar-wrap" v-if="form.energyType == 3 || form.energyType == 2">
          <span class="label-text">油量：</span>
          <el-row :gutter="20">
            <el-col :span="5">
              <div class="progress-bar">
                <span style="width: 50%;">
                  <label>{{form.oil}}%</label>
                </span>
              </div>
            </el-col>
            <el-col :span="2">
              <el-input size="small" value="100" v-model="form.oil"></el-input>
            </el-col>
          </el-row>
        </div>
      </el-form-item>
